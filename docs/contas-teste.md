...
| `helena@exemplo.local` | `desenvolvimento1` | profissional (Helena Duarte), link `helena-agenda` | **a da agenda.** Nasceu na Fase 6, e o motivo vale ser lido antes de reaproveitá-la: os testes da agenda montam perfil inteiro — local, quadra, modalidade com preço — e o desmontam no fim. Fazer isso no Sérgio derrubava, de forma intermitente, o arquivo que o suspende, porque os arquivos de teste **rodam em paralelo**. A regra é a que o próprio Sérgio já enunciava: **uma conta descartável não pode ter dois donos** |
