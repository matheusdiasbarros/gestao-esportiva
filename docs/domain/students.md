...
| ~~Teto de fichas por profissional: **500**~~ | ⚠️ **Esta linha estava errada, e a revisão de segurança da fase provou.** Ela afirmava que o teto limitava o oráculo a 500 endereços por conta. **Não limita nada:** o marcador é recalculado a **cada escrita** e o e-mail da ficha é **editável**, então uma única ficha testa infinitos endereços, um por requisição. Medido em 2026-08-28: ~7.200 endereços por hora, contidos só pelo teto global de 120/min. O teto de 500 continua existindo — como rede contra laço acidental, que é o que ele de fato é |
